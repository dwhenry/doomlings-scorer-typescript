...
addBasicCard({ score: 1 }, { name: 'LATE', type: ['colourless'] });
addBasicCard({ score: 1 }, { name: 'LEAVES', type: ['green'] });
addBasicCard({ score: 8 }, { name: 'LEGENDARY', type: ['blue'] });

addBasicCard({ score: 1 }, {
  name: 'LYONIZATION', type: ['green'],
